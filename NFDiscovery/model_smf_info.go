...
func (o SmfInfo) MarshalJSON() ([]byte, error) {
	...
	if o.VsmfSupportInd != nil {
		toSerialize["vsmfSupportInd"] = o.VsmfSupportInd
	}
	if o.PgwFqdnList != nil {
