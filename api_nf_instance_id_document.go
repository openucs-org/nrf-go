...
func (r ApiDeregisterNFInstanceRequest) Execute() (*_nethttp.Response, error) {
...
*/
func (a *NFInstanceIDDocumentApiService) DeregisterNFInstance(ctx _context.Context, nfInstanceID string) ApiDeregisterNFInstanceRequest {
	return ApiDeregisterNFInstanceRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *NFInstanceIDDocumentApiService) DeregisterNFInstanceExecute(r ApiDeregisterNFInstanceRequest) (*_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"nfInstanceID"+"}", _neturl.PathEscape(parameterToString(r.nfInstanceID, "")), -1)
...
func (r ApiGetNFInstanceRequest) Execute() (NFProfile, *_nethttp.Response, error) {
...
*/
func (a *NFInstanceIDDocumentApiService) GetNFInstance(ctx _context.Context, nfInstanceID string) ApiGetNFInstanceRequest {
	return ApiGetNFInstanceRequest{
		ApiService: a,
		ctx: ctx,
		nfInstanceID: nfInstanceID,
...
// Execute executes the request
//  @return NFProfile
func (a *NFInstanceIDDocumentApiService) GetNFInstanceExecute(r ApiGetNFInstanceRequest) (NFProfile, *_nethttp.Response, error) {
	var (
...
func (r ApiRegisterNFInstanceRequest) Execute() (NFProfile, *_nethttp.Response, error) {
...
*/
func (a *NFInstanceIDDocumentApiService) RegisterNFInstance(ctx _context.Context, nfInstanceID string) ApiRegisterNFInstanceRequest {
	return ApiRegisterNFInstanceRequest{
		ApiService: a,
		ctx: ctx,
		nfInstanceID: nfInstanceID,
...
// Execute executes the request
//  @return NFProfile
func (a *NFInstanceIDDocumentApiService) RegisterNFInstanceExecute(r ApiRegisterNFInstanceRequest) (NFProfile, *_nethttp.Response, error) {
	var (
...
func (r ApiUpdateNFInstanceRequest) Execute() (NFProfile, *_nethttp.Response, error) {
...
*/
func (a *NFInstanceIDDocumentApiService) UpdateNFInstance(ctx _context.Context, nfInstanceID string) ApiUpdateNFInstanceRequest {
	return ApiUpdateNFInstanceRequest{
		ApiService: a,
		ctx: ctx,
		nfInstanceID: nfInstanceID,
...
// Execute executes the request
//  @return NFProfile
func (a *NFInstanceIDDocumentApiService) UpdateNFInstanceExecute(r ApiUpdateNFInstanceRequest) (NFProfile, *_nethttp.Response, error) {
	var (
